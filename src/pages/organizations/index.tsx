...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'expenditure.count', 'income.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('expenditure', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('income', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'income',
          header: 'Income',
          accessorKey: 'income',
          cell: ({ row: { original: record } }: any) => record?._count?.income,
        }
      : null,
