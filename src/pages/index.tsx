...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Expenditure& income management `}</title>

        <meta
          name="description"
          content="Welcome to Expenditure& Income Management - Streamlining Your Building Construction Finances for Optimal Efficiency and Profitability."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb258ZW58MHx8fHwxNjg5OTg0MDc0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Expenditure& Income Management - Streamlining Your Building Construction Finances for Optimal Efficiency and Profitability.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Construction Manager" type="construction-manager" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
